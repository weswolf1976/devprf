...
function original(subj,run,seq)
...
if p.scanner == 0
    p.resolution = [1920 1080]; % desired resolution, compare to the 'actual' resolution below
    p.refresh_rate = 60;
...
p.n_segments  = 2; % for now
p.dot_speed   = 1.6; % deg/s was
...
p.fix_color = [0 0 0] * 255; %was 0.75 on all three
